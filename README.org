...
All my last projects involves scraping and developing a metric to ease decision-making.
* Project
...
* Workflow
** Data Analysis
[[file:img/svg/google data analysis summary.svg]]
** Data collection
[[file:img/svg/Data collection.svg]]
** Exploring data
[[file:img/svg/Data Analysis with R exploring.svg]]
** Hypothesize
[[file:img/svg/Hypothesis_copy.svg]]
* Notes
